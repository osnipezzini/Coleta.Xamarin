...
namespace SOColeta.Server.Migrations
{
    ...
    [Migration("20220427000139_Initial")]
            ...
            modelBuilder.Entity("SOColeta.Common.Models.Coleta", b =>
                {
                    ...
                    b.HasIndex("InventarioId")
                        .HasDatabaseName("ix_coletas_inventario_id");

                    b.HasIndex("ProdutoId")
                        .HasDatabaseName("ix_coletas_produto_id");
            ...
            modelBuilder.Entity("SOColeta.Common.Models.Coleta", b =>
                {
                    b.HasOne("SOColeta.Common.Models.Inventario", "Inventario")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_coletas_inventarios_inventario_id");

                    b.HasOne("SOColeta.Common.Models.Product", "Produto")
                        .WithMany()
                        .HasForeignKey("ProdutoId")
                        .HasConstraintName("fk_coletas_products_produto_id");
